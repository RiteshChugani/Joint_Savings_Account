...
* A folder named `Execution_Results` that contains the images of the  deposit and withdrawal transactions, which are designed to test the `JointSavings` functionality in the JavaScript VM, worked as expected.
...
Now that your contract is deployed, it’s time to test its functionality! The screenshot of below transactions are saved in a folder named `Execution_Results`. 
...
![accounts](Execution_Results/accounts.png)
...
3. Once you’ve successfully deposited funds into your contract, test the contract’s withdrawal functionality by withdrawing the following amounts of ether. After each transaction, use the `contractBalance` function to verify that the funds were withdrawn from your contract. Also, use the `lastToWithdraw` and `lastWithdrawAmount` functions to verify that the address and amount were correct.

    * Transaction 4: Withdraw 5 ether into `accountOne` 
![transaction_4](Execution_Results/transaction_4.png)
    
    * Transaction 5: Withdraw 10 ether into `accountTwo`. 
![transaction_5](Execution_Results/transaction_5.png)
---
